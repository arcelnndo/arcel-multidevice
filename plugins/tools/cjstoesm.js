...
async function handler(m, { sock }) {
    ...
    if (!code) {
        return m.reply(
            ...
            `Alat ini digunakan untuk mengubah format kode CommonJS (require/module.exports) menjadi ES Modules (import/export).\n\n` +
            `*Cara pakai:*\n` +
            `Reply pesan yang berisi kode CJS dengan mengetik \`${m.prefix}cjstoesm\`\n\n` +
            `*Contoh CJS:*\n` +
