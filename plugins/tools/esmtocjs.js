...
async function handler(m, { sock }) {
    ...
    if (!code) {
        return m.reply(
            ...
            `Alat ini digunakan untuk mengubah format kode ES Modules (import/export) menjadi CommonJS (require/module.exports).\n\n` +
            `*Cara pakai:*\n` +
            `Reply pesan yang berisi kode ESM dengan mengetik \`${m.prefix}esmtocjs\`\n\n` +
            `*Contoh ESM:*\n` +
    ...
    try {
        ...
        await sock.sendMessage(m.chat, {
            text: `*✅ HASIL CONVERT KE COMMONJS:*\n\n\`\`\`javascript\n${converted}\n\`\`\``,
            contextInfo: {
